...
const MUTATIONS = [
  ...
  { name: "金額の上限を効かせない", guards: "金額は上限で止める",
    file: "index.html", from: "  const amount=Math.min(typed, Core.AMOUNT_MAX);",
  ...
  { name: "編集で記録の国を取り違える", guards: "直しても記録の国は変わらない",
    file: "index.html", from: "  const recCountry = idx>=0 ? Core.normalizeCountry(state.tx[idx].country) : curCountry();",
  ...
  { name: "打ち込みを最小単位へ直さない", guards: "打ち込みは最小単位へ直す",
    file: "index.html", from: "  const typed=Core.toMinor(typedMajor, recCountry);",
    to: "  const typed=typedMajor;" },
