...
const MUTATIONS = [
  ...
  { name: "キャッシュの版数を上げ忘れる", guards: "更新が端末に届く",
    file: "sw.js", from: 'const CACHE = "kakeibo-v7";', to: 'const CACHE = "kakeibo-v6";' },
  ...
  { name: "月末の予測を経過日数で割らない", guards: "つかうペースの予測",
    file: "core.js", from: "    const forecast = elapsed > 0 ? Math.round((c.spendTotal / elapsed) * days) : 0;",
    to: "    const forecast = c.spendTotal;" },
