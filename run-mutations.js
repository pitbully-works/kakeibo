...
const MUTATIONS = [
  ...
  { name: "NISAのスケジュールを渡さない", guards: "スケジュールと銘柄もライフプランへ渡す",
    file: "core.js", from: "        tsumitateSchedule: a.tsumitateSchedule,\n        growthSchedule: a.growthSchedule,", to: "" },
  { name: "自動なのに月額の欄を書き戻す", guards: "読み取り専用の表示を書き戻さない",
    file: "index.html", from: "  if(!Core.nisaAuto(state.settings)) s.nisaMonthly=num(g(\"f-nisa\"));\n  s.birth=Core.normalizeBirth(g(\"f-birth\"));\n  s.goalName=(g(\"f-gname\")||\"\").slice(0,24);\n  s.goalTarget=num(g(\"f-gtarget\")); s.goalCurrent=num(g(\"f-gcur\"));\n  s.cycleStart=Core.normalizeCycleStart(g(\"f-cycle\"));\n  /* normalizeSettings",
    to: "  s.nisaMonthly=num(g(\"f-nisa\"));\n  s.birth=Core.normalizeBirth(g(\"f-birth\"));\n  s.goalName=(g(\"f-gname\")||\"\").slice(0,24);\n  s.goalTarget=num(g(\"f-gtarget\")); s.goalCurrent=num(g(\"f-gcur\"));\n  s.cycleStart=Core.normalizeCycleStart(g(\"f-cycle\"));\n  /* normalizeSettings" },
  ...
  { name: "ライフプランの入力まで上書きする", guards: "渡すのは4つだけ",
    file: "core.js", from: "        growthAllocation: a.growthAllocation,\n      },\n    };\n  }",
    to: "        growthAllocation: a.growthAllocation,\n        currentAge: 0,\n      },\n    };\n  }" },
  ...
  { name: "キャッシュの版数を上げ忘れる", guards: "更新が端末に届く",
    file: "sw.js", from: 'const CACHE = "kakeibo-v35";', to: 'const CACHE = "kakeibo-v34";' },
