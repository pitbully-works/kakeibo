...
const MUTATIONS = [
  ...
  { name: "キャッシュの版数を上げ忘れる", guards: "更新が端末に届く",
    file: "sw.js", from: 'const CACHE = "kakeibo-v6";', to: 'const CACHE = "kakeibo-v5";' },
